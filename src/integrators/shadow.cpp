...
Spectrum ShadowIntegrator::Li(const RayDifferential &ray,
	...
	L += UniformSampleAllLightsShadow(isect, scene, arena, sampler,
					  nLightSamples);
    }
...
ShadowIntegrator *CreateShadowIntegrator(
    ...
    return new ShadowIntegrator(strategy, maxDepth, camera, sampler,
                                        pixelBounds);
}
